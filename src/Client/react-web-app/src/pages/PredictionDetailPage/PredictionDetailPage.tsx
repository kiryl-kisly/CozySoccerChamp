		...
		<div className=''>
			<div className='flex flex-col items-center mt-5'>
					...
					<div className="result-match mx-3 w-1/5">
						{
							match?.matchResult?.status === 'Started' ? (
								<div className='bg-green-500 animate-pulse rounded-lg px-4 m-2 text-white font-normal text-3sm'>active</div>
							) : (
				...
				{predictions && predictions.length > 0 ? (
					<>
						<div className='title-sub w-full'><h3 className='font-semibold text-[var(--gray-light)] mt-5 mb-3 text-left'>Predictions</h3></div>
								...
								<div
									...
									<div className="flex items-center justify-center text-lg">
										...
										{match?.matchResult?.status === 'Finished' && (
											...
											>
												{prediction.pointPerMatch !== null
													? prediction.pointPerMatch * prediction.coefficient!
													: null}
											</div>
										)}
									</div>
