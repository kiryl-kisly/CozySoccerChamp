...
namespace CozySoccerChamp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250211212859_AddInitialValueToUserProfileAndNotificationSettings")]
    partial class AddInitialValueToUserProfileAndNotificationSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CozySoccerChamp.Domain.Entities.User.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CozySoccerChamp.Domain.Entities.User.NotificationSettings", b =>
                {
                    ...
                    b.Property<bool>("IsForceNotificationEnabled")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("CozySoccerChamp.Domain.Entities.User.UserProfile", b =>
                {
                    b.HasOne("CozySoccerChamp.Domain.Entities.User.ApplicationUser", "User")
                        .WithOne("Profile")
                        .HasForeignKey("CozySoccerChamp.Domain.Entities.User.UserProfile", "TelegramUserId")
                        .HasPrincipalKey("CozySoccerChamp.Domain.Entities.User.ApplicationUser", "TelegramUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
